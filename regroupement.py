...
REGROUPEMENT_CATECHISME = {
    ...
    "grandes_parties": [
        "PROLOGUE",
        'PREMIERE_SECTION_JE_CROIS__NOUS_CROYONS',
        "DEUXIEME_PARTIE_LA_CELEBRATION_DU_MYSTERE_CHRETIEN",
        "TROISIEME_PARTIE_LA_VIE_DANS_LE_CHRIST",
        "PREMIERE_SECTION_LA_PRIERE_DANS_LA_VIE_CHRETIENNE"
    ]
}
